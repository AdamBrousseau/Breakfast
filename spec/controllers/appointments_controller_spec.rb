...
describe AppointmentsController do
  ...
  let(:valid_attributes) { { "doctor" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved appointment as @appointment" do
        ...
        post :create, {:appointment => { "doctor" => "invalid value" }}, valid_session
        assigns(:appointment).should be_a_new(Appointment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested appointment" do
        ...
        Appointment.any_instance.should_receive(:update).with({ "doctor" => "MyString" })
        put :update, {:id => appointment.to_param, :appointment => { "doctor" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the appointment as @appointment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Appointment.any_instance.stub(:save).and_return(false)
        put :update, {:id => appointment.to_param, :appointment => { "doctor" => "invalid value" }}, valid_session
        assigns(:appointment).should eq(appointment)
      end
